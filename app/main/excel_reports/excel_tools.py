...
def create_all_statistics_sheet(workbook, report, report_start_time, report_finish_time, vertical=False, start_position=1):
    ...
    for elem_num, statistic in enumerate(report_statistics, start_position):
        if vertical:
            ...
            insert_data_to_cell(worksheet, statistic.maximum_road_length, 4, elem_num)
            insert_data_to_cell(worksheet, statistic.average_route_length, 5, elem_num)
            insert_data_to_cell(worksheet, statistic.accessible_nodes_percent, 6, elem_num)
            insert_data_to_cell(worksheet, statistic.elapsed_time, 7, elem_num)
            insert_data_to_cell(worksheet, statistic.total_esl, 8, elem_num)
            insert_data_to_cell(worksheet, statistic.online_esl, 9, elem_num)
            insert_data_to_cell(worksheet, statistic.images_in_transit, 10, elem_num)
            insert_data_to_cell(worksheet, statistic.images_in_draw, 11, elem_num)
            insert_data_to_cell(worksheet, statistic.images_in_resend_queue, 12, elem_num)
            insert_data_to_cell(worksheet, statistic.images_succeeded, 13, elem_num)
            insert_data_to_cell(worksheet, statistic.images_failed, 14, elem_num)
            insert_data_to_cell(worksheet, statistic.currently_scanning, 15, elem_num)
            insert_data_to_cell(worksheet, statistic.network_mode, 16, elem_num)
            insert_data_to_cell(worksheet, statistic.connects, 17, elem_num)
            insert_data_to_cell(worksheet, statistic.network_mode_percent, 18, elem_num)
            insert_data_to_cell(worksheet, statistic.voltage_average, 19, elem_num)
            insert_data_to_cell(worksheet, statistic.voltage_current, 20, elem_num)
            insert_data_to_cell(worksheet, statistic.voltage_max, 21, elem_num)
            insert_data_to_cell(worksheet, statistic.bat_reserved1, 22, elem_num)
            insert_data_to_cell(worksheet, statistic.bat_reserved2, 23, elem_num)
            insert_data_to_cell(worksheet, statistic.bat_reserved3, 24, elem_num)
            insert_data_to_cell(worksheet, statistic.bat_reserved4, 25, elem_num)
        else:
            ...
            insert_data_to_cell(worksheet, statistic.maximum_road_length, elem_num, 4)
            insert_data_to_cell(worksheet, statistic.average_route_length, elem_num, 5)
            insert_data_to_cell(worksheet, statistic.accessible_nodes_percent, elem_num, 6)
            insert_data_to_cell(worksheet, statistic.elapsed_time, elem_num, 7)
            insert_data_to_cell(worksheet, statistic.total_esl, elem_num, 8)
            insert_data_to_cell(worksheet, statistic.online_esl, elem_num, 9)
            insert_data_to_cell(worksheet, statistic.images_in_transit, elem_num, 10)
            insert_data_to_cell(worksheet, statistic.images_in_draw, elem_num, 11)
            insert_data_to_cell(worksheet, statistic.images_in_resend_queue, elem_num, 12)
            insert_data_to_cell(worksheet, statistic.images_succeeded, elem_num, 13)
            insert_data_to_cell(worksheet, statistic.images_failed, elem_num, 14)
            insert_data_to_cell(worksheet, statistic.currently_scanning, elem_num, 15)
            insert_data_to_cell(worksheet, statistic.network_mode, elem_num, 16)
            insert_data_to_cell(worksheet, statistic.connects, elem_num, 17)
            insert_data_to_cell(worksheet, statistic.network_mode_percent, elem_num, 18)
            insert_data_to_cell(worksheet, statistic.voltage_average, elem_num, 19)
            insert_data_to_cell(worksheet, statistic.voltage_current, elem_num, 20)
            insert_data_to_cell(worksheet, statistic.voltage_max, elem_num, 21)
            insert_data_to_cell(worksheet, statistic.bat_reserved1, elem_num, 22)
            insert_data_to_cell(worksheet, statistic.bat_reserved2, elem_num, 23)
            insert_data_to_cell(worksheet, statistic.bat_reserved3, elem_num, 24)
            insert_data_to_cell(worksheet, statistic.bat_reserved4, elem_num, 25)
